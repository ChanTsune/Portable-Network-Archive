...
pub(crate) type EncryptCbcCamellia256Writer<W> = block::CbcBlockCipherEncryptWriter<W, Camellia256, Pkcs7>;
pub(crate) type DecryptCbcCamellia256Reader<R> = block::CbcBlockCipherDecryptReader<R, Camellia256, Pkcs7>;
