...
#[derive(Parser, Clone, Eq, PartialEq, Hash, Debug)]
#[command(group(
    ArgGroup::new("restore-source").args(["restore", "restore_from_stdin"])
))]
pub(crate) struct SetXattrCommand {
    ...
    #[arg(
        ...
        long,
        value_name = "NAME",
        help = "Remove extended attribute"
    )]
    remove: Option<String>,
    #[arg(
        long,
        value_name = "FILE",
        help = "Restore extended attributes from a file in the format generated by pna xattr get --dump. For compatibility, '-' temporarily reads from standard input; use --restore-from-stdin instead",
        value_hint = ValueHint::FilePath
    )]
    restore: Option<PathBuf>,
    #[arg(
        long,
        help = "Restore extended attributes from standard input in the format generated by pna xattr get --dump"
    )]
