...
- The positional archive argument `<ARCHIVE>` is deprecated. Use `-f/--file <ARCHIVE>` instead. The positional form is still accepted for backward compatibility and will emit a warning. It may be removed in a future release.
