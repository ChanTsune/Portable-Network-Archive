...
fn stdio_archive_inclusion_ordering() {
    ...
    assert_eq!(
        entry_names[0], "file_a.txt",
        "First entry should be file_a.txt"
    );
    assert_eq!(
    ...
    assert_eq!(
        entry_names[3], "file_b.txt",
        "Fourth entry should be file_b.txt"
    );
    assert_eq!(
        entry_names[4], "file_c.txt",
        "Fifth entry should be file_c.txt"
    );
