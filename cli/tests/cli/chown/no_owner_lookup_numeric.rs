...
/// Action: Run `pna experimental chown` with `--numeric-owner --no-owner-lookup` to change owner by ID.
/// Expectation: The target entry has updated uid/gid with empty uname/gname;
